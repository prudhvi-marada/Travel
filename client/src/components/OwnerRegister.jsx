    ...
    <div>
        ...
        <div className="background-shape"></div>
             <div className="container">
                ...
                <img className="big-logo" src={imgfolder} alt="" ></img> <p style={{color:'white'}}>Owner Register</p>                
      ...
      {validationErrors.phone && <p style={{ color: 'white' }}>{validationErrors.phone}</p>}
                ...
                <button className="btn btn-warning btn-lg w-100" type="submit">Sign Up</button>
                    ...
                    <p className="mt-3 mb-0">Already have an account?<Link to="/owner_login" className="ms-1" >Sign In</Link></p>
                    </div>
