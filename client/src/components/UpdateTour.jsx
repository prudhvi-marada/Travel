      ...
      try {
        ...
        if (response.ok) {
          ...
          setEditedTour({
            ...
            deparrival: data.deparrival ,
            accdetails: data.accdetails ,
            reportdrop: data.reportdrop ,
  ...
  const handleUpdateTour  = async (e) =>  {
    ...
    try {
      ...
      if (response.ok) {
        ...
        console.error('Not updating Tour details:', response.statusText);
      }
    } catch (error) {
      console.error('Error updating Tour details:', error.message);
    }
  };
            ...
            <div className="card-body">
              ...
              <div className="title mb-2"><span>Itinerary:</span></div>
                    <textarea 
                      ...
                      name="itinerary" 
                      id="itinerary"
                      value={editedTour.itinerary}
                      onChange={handleInputChange} 
                      placeholder='Itinerary'/>
              </div>

                <div className="mb-3">
                      <div className="title mb-2"><span>Departue Arrival</span></div>
                    <input className="form-control" name="deparrival" id="deparrival"value={editedTour.deparrival}
                      onChange={handleInputChange}  type="text"/>
                </div>

                <div className="mb-3">
                      <div className="title mb-2"><span>Accomodation Details</span></div>
                    <input className="form-control" name="accdetails" id="accdetails"value={editedTour.accdetails}
                      onChange={handleInputChange}  type="text"/>
                </div>

                <div className="mb-3">
                      <div className="title mb-2"><span>Reporting & Dropping</span></div>
                    <input className="form-control" name="reportdrop" id="reportdrop"value={editedTour.reportdrop}
                      onChange={handleInputChange} type="text"/>
                </div>
